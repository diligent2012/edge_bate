...
def set_stop_price_order(client, sell_price, stop_sell_price, sell_qty, newClientOrderId):
    ...
    if(set_stop_record_result):
        stopPrice = set_stop_record_result['stopPrice']
        price = set_stop_record_result['price']
        origQty = set_stop_record_result['origQty']
        orderId = set_stop_record_result['orderId']
...
# def get_curr_max_price_24(client):
#     max_price = 0.0
